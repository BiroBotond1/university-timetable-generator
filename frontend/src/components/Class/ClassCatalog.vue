 ...
 export default {
    data () {
      return {
        ...
        classID: '64345afe10265ba59827241e',
        catalog:
           [["", "", "", "", "", "", "", ""],
           ["", "", "", "", "", "", "", ""],
           ["", "", "", "", "", "", "", ""],
    ...
    methods: {
        ...
        async fetchCatalog() {
          ...
          for(var day = 0; day < catalogIDs.length; day++)
          {
            for(var hour = 0; hour < catalogIDs[day].length; hour++) {
                console.log(this.catalog[day][hour])
                if(catalogIDs[day][hour] === '') {
                    this.catalog[day][hour] = ''
                } else {
        ...
        getSubjectName(day, hour) {
            if (this.subjects[day][hour] === '') {
                return '';
            }
            return this.classHours[this.subjects[day][hour]].subject.name
        },
    },
}
